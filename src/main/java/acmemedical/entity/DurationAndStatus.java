/********************************************************************************************************
1 * File:  DurationAndStatus.java Course Materials CST 8277
 *
 * @author Teddy Yap
 * 
 */
...
import jakarta.persistence.Embeddable; // DS01: Mark this class as embeddable
import jakarta.persistence.Column;    // DS02, DS03, DS04: Add JPA column annotations
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DurationAndStatus otherDurationAndStatus) {
            ...
            return Objects.equals(this.getStartDate(), otherDurationAndStatus.getStartDate()) &&
                    ...
                    this.getActive() == otherDurationAndStatus.getActive();
        }
        return false;
    }
}
