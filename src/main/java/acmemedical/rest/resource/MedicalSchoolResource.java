...
public class MedicalSchoolResource {
    ...
    @GET
    // Specify the roles allowed for this method
    @RolesAllowed({ADMIN_ROLE, USER_ROLE}) // Any user or admin can access this method
    ...
    @DELETE
    // Specify the roles allowed for this method
    @RolesAllowed({ADMIN_ROLE}) // Only admins can delete a medical school
    @Path("/{medicalSchoolId}")
