...
class DurationAndStatusTest {
    ...
    void testGetStartDate() {
        assertEquals(LocalDateTime.of(2024, 12, 1, 10, 0), durationAndStatus1.getStartDate());
    }

    @Test
    void testSetStartDate() {
        LocalDateTime newStartDate = LocalDateTime.of(2024, 12, 5, 12, 0);
        durationAndStatus1.setStartDate(newStartDate);
        assertEquals(newStartDate, durationAndStatus1.getStartDate());
    }

    @Test
    void testGetEndDate() {
        assertEquals(LocalDateTime.of(2024, 12, 10, 18, 0), durationAndStatus1.getEndDate());
    }
